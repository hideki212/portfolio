        ...
        >
          <div className='p-3 bg-gray-200 dark:bg-gray-800 flex justify-between items-center gap-3'>
            ...
            <div className='flex items-center gap-2'>
              <div className='text-white w-8 h-8 bg-[#6d32a5] dark:bg-[#07d0e5] rounded-full flex justify-center items-center'>
                S
              </div>
              <p className='text-gray-400 flex'>
                <span className='text-lg font-bold'>HIDEKI</span> <DiTechcrunch />
              </p>
            </div>
