        ...
        >
          ...
          >
            ...
            <p className='text-2xl md:text-4xl py-2 font-semibold font-sans'>
              I&apos;m Hideki a full stack developer in
              <span className='text-[#6d32a5] dark:text-[#07d0e5]'>
                {" "}
                 .net core and react <span className='text-white'>|</span>
              </span>
            </p>
            <div className='mt-5 md:mt-10 flex gap-3'>
              {/* Hire Me Button */}
              <Link
                className='text-white text-xl font-semibold rounded bg-[#cabe52] hover:bg-[#a09743] px-2 py-1'
                href={"#getInTouch"}
              >
                Hire me
              </Link>
              {/* Download CV Button */}
              <Link
                className='text-xl font-semibold rounded border border-[#a09743] hover:text-white hover:bg-[#a09743] px-2 py-1'
                href='https://docs.google.com/document/d/1Hir0zs-1nJ77gDpHgdvKLrPQBmdOiQGtf0V7RlwzJEg'
                target='_blank'
              >
                Download CV
              </Link>
